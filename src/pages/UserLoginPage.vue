  ...
  <div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center p-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Sign in to view your application</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            Check your email for login credentials sent after application submission.
          </p>
        </div>
      </div>
      ...
      <div class="mt-8 text-center">
        <p class="text-sm text-gray-600">
          ...
          <a href="/" class="font-semibold text-purple-600 hover:text-purple-700">Submit an application</a>
        </p>
      </div>
    </div>
  </div>
