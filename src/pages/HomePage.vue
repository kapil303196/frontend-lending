  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
      <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
        <div
          class="w-20 h-20 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <span class="text-white font-bold text-3xl">FD</span>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-center justify-center space-x-2 text-gray-600">
            ...
            <span>Need help? Call us at <a href="tel:8006412609" class="text-blue-600 font-semibold">(800)
                641-2609</a></span>
          </div>
        </div>
