<template>
  <div
    class="group bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 cursor-pointer border border-gray-200 hover:border-indigo-300"
    @click="$emit('click')">
    <!-- Header -->
    <div class="flex items-start justify-between mb-4">
      ...
      <div class="flex items-center gap-2">
        <span :class="statusColorClass" class="px-3 py-1 rounded-full text-xs font-medium">
          {{ response.status }}
        </span>
        <!-- Delete Button (visible on hover) -->
        <button @click.stop="$emit('delete', response)"
