    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <input
          ...
          @input="formatPhone"
        />
        <p class="mt-1 text-xs text-gray-500">By submitting your phone number you accept to receive messages from Fund Direct</p>
      </div>
      ...
      <div>
        ...
        <div class="relative">
          <input
            v-model.number="localData.ownershipPercent"
            type="number"
            min="0"
            max="100"
            required
      ...
      <div class="md:col-span-2">
        <AddressAutocomplete
          v-model="localData.ownerStreetAddress"
          label="Street Address"
          placeholder="Start typing your address..."
          :required="true"
          @addressSelected="handleOwnerAddressSelected"
        />
      </div>
      ...
      <div class="md:col-span-2">
        ...
        <input
          v-model="localData.fundDirectSpecialist"
          type="text"
          required
          class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
